...
import { Activity, BrainCircuit, ScrollText, ShieldCheck } from "lucide-react";
      ...
      <aside className="hidden lg:flex flex-col justify-between p-12 xl:p-16 relative overflow-hidden"
        ...
        <div className="relative max-w-lg">
          <h1 className="text-3xl xl:text-4xl font-semibold leading-tight tracking-tight"
            ...
            An AI system administrator for your Windows fleet.
          </h1>
          <p className="mt-4 text-base leading-relaxed" style={{ color: "var(--text-secondary)" }}>
            ASTRA watches every device, works out what is actually wrong, and fixes it — with
            a human in the loop wherever that matters.
          </p>
